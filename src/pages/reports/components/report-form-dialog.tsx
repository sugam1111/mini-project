...
import type { Report, ReportDialog } from "../types";
...
export default function ReportFormDialog({
  ...
  return (
    ...
    >
      ...
      <DialogFooter>
        <Button
          className="bg-red-500 hover:bg-red-600 hover:text-white text-white font-bold"
          variant="outline"
          onClick={close}
        >
          Cancel
        ...
        <Button
          className="bg-blue-800 hover:bg-blue-900 font-bold"
          onClick={handleSave}
          disabled={saving}
        >
