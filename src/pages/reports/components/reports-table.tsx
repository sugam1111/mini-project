  ...
  const handleDelete = useCallback(
    async (report: Report) => {
      ...
      try {
        ...
        appToast({
          type: "error",
          description: `Failed to delete report "${report.title}"`,
        });
      }
    },
    [del, appToast],
    ...
    <div className="mx-4 overflow-x-hidden md:max-w-200 lg:max-w-full">
      <div className="w-full min-w-0 space-y-3">
        <div className="w-full min-w-0 rounded-2xl bg-white px-1">
          <div className="flex flex-col gap-5">
            <div className="flex min-w-0 flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <Button
                onClick={onAdd}
                className="h-10 w-full shrink-0 cursor-pointer rounded-xl bg-purple-700 px-4 text-sm font-medium text-white shadow-sm transition hover:bg-purple-900 sm:h-11 sm:w-auto sm:px-5"
              >
                Add Report
              </Button>
            </div>
        ...
        <div className="w-full min-w-0 overflow-hidden rounded-2xl border border-purple-200 bg-white shadow-sm">
          <div className="min-h-87.5 w-full min-w-0 overflow-x-auto">
